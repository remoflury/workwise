<div id="menu-mobile" class="lg:hidden absolute inset-0 h-screen w-screen bg-white top-full translate-x-full transition delay-100 duration-300">
  <ul class="container w-full h-full flex flex-col gap-4 items-center justify-center">
    ...
    <?php } else { ?>
      <li>
        <p class="text-xl font-semibold"><a href="dummysite.php">Kontakt</a></p>
      </li>
    <?php } ?>
